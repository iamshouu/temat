      ...
      <div className="relative z-10 grid h-full grid-rows-[1fr_auto] p-5 pt-24 md:p-12 md:pt-32">
        ...
        >
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="group flex md:inline-flex w-full md:w-auto items-center justify-center gap-3 border border-accent px-4 md:px-6 py-3.5 md:py-3 font-mono text-[10px] md:text-[12px] uppercase tracking-[0.12em] md:tracking-[0.2em] text-accent transition-colors duration-300 hover:bg-accent hover:text-bg"
          >
            [ написать в telegram&nbsp;→ ]
          </a>
        </motion.div>
